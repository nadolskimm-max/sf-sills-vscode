...
```
Work Order
â”śâ”€â”€ Work Order Line Item (individual tasks)
â”śâ”€â”€ Service Appointment (scheduled time slot)
â”‚   â”śâ”€â”€ Assigned Resource (technician)
â”‚   â””â”€â”€ Service Territory
â”śâ”€â”€ Required Skill (skills needed)
â””â”€â”€ Product Required / Consumed
    â””â”€â”€ Product Item (inventory)

Service Resource (technician)
â”śâ”€â”€ Service Territory Member (territory assignments)
â”śâ”€â”€ Resource Skill (technician skills)
â”śâ”€â”€ Resource Capacity (working hours)
â””â”€â”€ Service Crew Member (team assignments)
```
...
â”śâ”€â”€ Screen: Confirm arrival (update status to "In Progress")
â”śâ”€â”€ Screen: Checklist of tasks
â”‚   â””â”€â”€ Loop: For each Work Order Line Item
â”‚       â”śâ”€â”€ Checkbox: Task completed
â”‚       â””â”€â”€ Text: Notes
â”śâ”€â”€ Screen: Parts consumed
â”‚   â””â”€â”€ Add Product Consumed records
â”śâ”€â”€ Screen: Customer signature (capture component)
â””â”€â”€ Update: Service Appointment status â†’ "Completed"
```
