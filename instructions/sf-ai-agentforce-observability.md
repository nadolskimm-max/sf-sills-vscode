---
description: >-
  Traces and analyzes Agentforce agent sessions using Data Cloud and platform logs. Use when investigating agent behavior in production, extracting session transcripts, analyzing topic routing accuracy, or monitoring agent performance metrics. Do NOT use for agent configuration (use sf-ai-agentforce) or pre-deployment testing (use sf-ai-agentforce-testing).
---
