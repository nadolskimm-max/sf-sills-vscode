---
description: >-
  Creates Salesforce formula fields, validation rules, and formula-based automation. Use when writing formula field expressions, building validation rules, troubleshooting formula compilation errors, or optimizing formula performance (compiled size limits). Do NOT use for SOQL queries (use sf-soql) or Flow formulas (use sf-flow).
applyWhen: "**/*.validationRule-meta.xml"
---
