---
description: >-
  Creates Agent Script DSL files for defining conversational flows using finite state machine patterns. Use when writing .agent script files, designing conversation state machines, defining agent dialog trees, or working with Agent Script syntax. Do NOT use for Agent Builder configuration (use sf-ai-agentforce) or persona design (use sf-ai-agentforce-persona).
applyWhen: "**/*.agent"
---
...
```
Start -> Classify
  â”śâ”€â”€ Topic A -> Process A -> Confirm -> End
  â”śâ”€â”€ Topic B -> Process B -> Confirm -> End
  â””â”€â”€ Unknown -> Clarify -> Start
```

### Loop with Retry
```
AskInput -> Validate
  â”śâ”€â”€ valid -> Process
  â””â”€â”€ invalid -> AskInput (max 3, then Escalate)
```
