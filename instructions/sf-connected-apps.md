---
description: >-
  Creates and manages Salesforce Connected Apps and External Client Apps for OAuth integrations. Use when configuring OAuth flows (JWT Bearer, Authorization Code, Client Credentials, PKCE), creating Connected App metadata, or migrating to External Client Apps. Do NOT use for Named Credentials (use sf-integration) or general API callouts (use sf-integration).
applyWhen: "**/*.connectedApp-meta.xml"
---
