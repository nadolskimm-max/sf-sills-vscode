---
description: >-
  Plans and executes Salesforce org migrations including metadata comparison, data migration strategies, and org-to-org transfers. Use when migrating between orgs, comparing metadata between environments, planning data migration, or converting from classic to Lightning. Do NOT use for regular deployment (use sf-deploy) or data import/export only (use sf-data).
---
