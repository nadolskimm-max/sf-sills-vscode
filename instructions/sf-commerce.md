---
description: >-
  Builds Salesforce B2B and B2C Commerce storefronts including product catalogs, carts, checkout flows, pricing, and order management. Use when configuring Commerce Cloud storefronts, building custom commerce components, managing product catalogs, or integrating payment gateways. Do NOT use for standard Salesforce UI (use sf-lwc) or CPQ pricing (use sf-cpq).
---
...
```
Store (WebStore)
â”śâ”€â”€ Product Catalog
â”‚   â”śâ”€â”€ Product Category
â”‚   â”‚   â””â”€â”€ Product Category Product
â”‚   â””â”€â”€ Product2
â”‚       â”śâ”€â”€ Product Media
â”‚       â””â”€â”€ Product Attribute
â”śâ”€â”€ Buyer Group
â”‚   â””â”€â”€ Buyer Account
â”śâ”€â”€ Entitlement Policy
â”śâ”€â”€ Price Book (Pricebook2)
â”‚   â””â”€â”€ Price Book Entry
â”śâ”€â”€ Cart (WebCart)
â”‚   â””â”€â”€ Cart Item (CartItem)
â”śâ”€â”€ Checkout Session
â””â”€â”€ Order / Order Summary
    â””â”€â”€ Order Item / Order Item Summary
```
...
```
Cart Review
â”śâ”€â”€ Validate inventory availability
â”śâ”€â”€ Apply promotions / coupons
â”śâ”€â”€ Calculate shipping
â”śâ”€â”€ Calculate tax (external tax engine)
â”śâ”€â”€ Payment capture (payment gateway)
â””â”€â”€ Place Order â†’ Create OrderSummary
```
