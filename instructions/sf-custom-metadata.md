---
description: >-
  Creates and manages Custom Metadata Types, Custom Settings, and Custom Labels for Salesforce configuration. Use when building configurable applications, implementing feature flags, choosing between CMT vs Custom Settings vs Custom Labels, or creating metadata-driven logic. Do NOT use for custom objects (use sf-metadata) or permission configuration (use sf-permissions).
---
...
// Access (checks User â†’ Profile â†’ Org default)
