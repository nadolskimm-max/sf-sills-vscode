---
description: >-
  Creates and manages Salesforce email functionality including Lightning email templates, email alerts, email services, and org-wide email addresses. Use when building email templates, configuring email alerts for workflows/approvals, setting up inbound email services, or troubleshooting email deliverability. Do NOT use for Messaging/Chat (use sf-cloud-service) or Platform Events (use sf-integration).
---
