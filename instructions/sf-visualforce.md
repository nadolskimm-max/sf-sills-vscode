---
description: >-
  Maintains Salesforce Visualforce pages and plans migration to LWC. Use when working with existing VF pages, VF controllers, PDF generation via VF, or planning VF-to-LWC migration strategy. Do NOT use for new UI development (use sf-lwc â€” Visualforce is legacy). Do NOT use for Aura migration (use sf-aura).
applyWhen: "**/*.page,**/*.component"
---
...
|---|---|---|
| PDF generation (`renderAs="pdf"`) | Yes â€” no LWC equivalent | Use VF for PDF, LWC for UI |
| Complex email templates with HTML | Partial â€” Lightning templates limited | VF email templates for complex HTML |
| Override standard buttons | No â€” use LWC Quick Actions | Migrate |
| Custom tabs/pages | No â€” use LWC | Migrate |
| Canvas apps | Yes â€” Canvas requires VF | Keep VF |
| Flow screens | No â€” use LWC screen components | Migrate |
...
<!-- Remote actions â€” use $RemoteAction for CSRF token -->
