---
description: >-
  Builds Sales Cloud features including Opportunity products, Quotes, Forecasting, Territory Management, and sales processes. Use when configuring sales paths, setting up opportunity products/price books, creating quote templates, or building sales-specific automation. Do NOT use for general Apex (use sf-apex) or reports (use sf-reporting).
---
...
```
Global Territory
â”śâ”€â”€ North America
â”‚   â”śâ”€â”€ US West
â”‚   â”‚   â”śâ”€â”€ California
