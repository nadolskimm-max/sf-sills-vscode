---
description: >-
  Generates Mermaid diagrams for Salesforce architecture documentation including ERD diagrams, OAuth flow sequences, integration architecture, and system landscape diagrams. Use when creating visual documentation, data model diagrams, flow diagrams, or architecture overviews. Do NOT use for code generation (use respective skills).
---
...
### Sequence â€” JWT Bearer OAuth Flow
...
### Sequence â€” Authorization Code + PKCE
...
### Flowchart â€” Integration Architecture
...
### Flowchart â€” Deployment Pipeline
...
### Class Diagram â€” Apex Architecture
