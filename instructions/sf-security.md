---
description: >-
  Manages Salesforce security model including sharing rules, org-wide defaults, field-level security, encryption, and security review preparation. Use when configuring record access, troubleshooting sharing issues, setting up Shield Platform Encryption, or preparing for Salesforce Security Review. Do NOT use for Permission Sets only (use sf-permissions) or OAuth apps (use sf-connected-apps).
---
...
Organization-Wide Defaults (most restrictive baseline)
  â””â”€â”€ Role Hierarchy (opens access up the hierarchy)
      â””â”€â”€ Sharing Rules (opens access to groups/roles)
          â””â”€â”€ Manual Sharing (individual record grants)
              â””â”€â”€ Apex Managed Sharing (programmatic)
```
