---
description: >-
  Builds Salesforce Data Cloud (CDP) features including data model objects, segments, calculated insights, identity resolution, and data streams. Use when configuring Data Cloud data models, creating segments, setting up data streams, or querying Data Cloud objects. Do NOT use for standard SOQL (use sf-soql) or regular data operations (use sf-data).
---
