---
description: >-
  Builds Service Cloud features including Cases, Omni-Channel routing, Knowledge articles, Entitlements, Milestones, and Messaging. Use when configuring case management, setting up Omni-Channel, creating Knowledge articles, or building service console components. Do NOT use for general Apex (use sf-apex) or Experience Cloud portals (use sf-experience-cloud).
---
