---
description: >-
  Builds CRM Analytics (formerly Tableau CRM / Einstein Analytics) dashboards, datasets, lenses, and SAQL/SOQL queries. Use when creating analytics dashboards, writing SAQL queries, configuring dataflows and recipes, or embedding analytics in Lightning pages. Do NOT use for standard reports (use sf-reporting) or Data Cloud (use sf-data-cloud).
---
