---
description: >-
  Maintains and migrates Salesforce Aura components to Lightning Web Components. Use when working with existing Aura components, planning Aura-to-LWC migration, understanding Aura event architecture, or building Aura wrappers for LWC interop. Do NOT use for new component development (use sf-lwc instead â€” LWC is the current standard).
applyWhen: "**/aura/**/*.cmp,**/aura/**/*.js"
---
