---
description: >-
  Generates and reviews Salesforce Apex code following best practices. Use when writing, reviewing, or fixing Apex classes, triggers, batch jobs, or queueable/schedulable Apex. Covers Trigger Actions Framework, bulk patterns, governor limits, error handling, and test generation. Do NOT use for LWC JavaScript (use sf-lwc), Flow XML (use sf-flow), or raw SOQL files (use sf-soql).
applyWhen: "**/*.cls,**/*.trigger"
---
