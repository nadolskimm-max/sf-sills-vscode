---
description: >-
  Analyzes and manages Salesforce permissions including Permission Sets, Permission Set Groups, Profiles, and sharing rules. Use when answering "who has access to X?", creating permission sets, comparing profiles, auditing field-level security, or troubleshooting access issues. Do NOT use for metadata XML generation (use sf-metadata) or deployment (use sf-deploy).
applyWhen: "**/*.permissionset-meta.xml"
---
