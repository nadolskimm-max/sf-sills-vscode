---
description: >-
  Analyzes Salesforce debug logs, diagnoses governor limit violations, and identifies performance bottlenecks. Use when investigating errors, analyzing debug logs, fixing SOQL-in-loop issues, CPU time violations, heap size errors, or mixed DML exceptions. Do NOT use for writing new Apex logic (use sf-apex) or running tests (use sf-testing).
---
...
1. **FATAL_ERROR** lines â€” the root cause
2. **LIMIT_USAGE_FOR_NS** â€” governor limit consumption
3. **DML_BEGIN/DML_END** inside **LOOP** â€” DML in loop
4. **SOQL_EXECUTE_BEGIN** count > 100 â€” too many queries
5. **CUMULATIVE_LIMIT_USAGE** at end â€” overall consumption
...
```
Number of SOQL queries: 95 out of 100     â† WARNING: near limit
Number of DML statements: 148 out of 150  â† CRITICAL: near limit
Maximum CPU time: 8500 out of 10000       â† WARNING: 85% consumed
Maximum heap size: 4500000 out of 6000000 â† OK: 75%
```

### Priority thresholds:
- **> 90%** of any limit â†’ CRITICAL â€” will fail at scale
- **> 70%** of any limit â†’ WARNING â€” refactor recommended
- **< 50%** of all limits â†’ HEALTHY
