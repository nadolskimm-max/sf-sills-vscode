---
description: >-
  Manages Salesforce data operations including SOQL queries, test data factories, record import/export, and Bulk API operations. Use when querying data, creating test data factories, importing/exporting CSV, or performing bulk data operations. Do NOT use for query optimization theory (use sf-soql) or Apex DML patterns (use sf-apex).
---
