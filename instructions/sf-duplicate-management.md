---
description: >-
  Configures Salesforce duplicate detection and management including Duplicate Rules, Matching Rules, merge operations, and data quality monitoring. Use when setting up duplicate prevention, creating matching rules, merging duplicate records, or building data quality dashboards. Do NOT use for general data operations (use sf-data) or validation rules (use sf-formula).
---
