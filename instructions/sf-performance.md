---
description: >-
  Optimizes Salesforce platform performance across Apex, SOQL, LWC, Flows, and UI. Use when diagnosing slow pages, optimizing Apex execution, reducing SOQL query time, improving LWC rendering, or tuning Flow performance. Do NOT use for debugging specific errors (use sf-debug) or writing new code (use respective skills).
---
...
### Step 1 â€” Identify the Bottleneck
...
| Avoid reactive loops (tracked prop â†’ handler â†’ tracked prop) | Prevents infinite re-renders |
