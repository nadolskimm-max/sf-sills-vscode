---
description: >-
  Creates and manages Salesforce reports, dashboards, custom report types, and analytic snapshots. Use when building report metadata XML, creating dashboard components, designing custom report types, or troubleshooting report performance. Do NOT use for SOQL queries (use sf-soql) or data exports (use sf-data).
applyWhen: "**/*.report-meta.xml,**/*.dashboard-meta.xml"
---
