---
description: >-
  Builds Salesforce Agentforce agents using Agent Builder, PromptTemplates, Models API, and GenAi metadata. Use when creating agents, topics, actions, GenAiFunction/GenAiPlanner metadata, or working with Einstein Models API. Do NOT use for persona design (use sf-ai-agentforce-persona), testing (use sf-ai-agentforce-testing), or observability (use sf-ai-agentforce-observability).
---
...
```
Agent (GenAiPlanner)
â”śâ”€â”€ Topic: Order Management
â”‚   â”śâ”€â”€ Action: Look Up Order (GenAiFunction â†’ Apex)
â”‚   â”śâ”€â”€ Action: Cancel Order (GenAiFunction â†’ Flow)
â”‚   â””â”€â”€ Action: Track Shipment (GenAiFunction â†’ API)
â”śâ”€â”€ Topic: Returns & Refunds
â”‚   â”śâ”€â”€ Action: Initiate Return (GenAiFunction â†’ Flow)
â”‚   â””â”€â”€ Action: Check Refund Status (GenAiFunction â†’ Apex)
â””â”€â”€ Guardrails
    â”śâ”€â”€ Max actions per turn: 5
    â”śâ”€â”€ Escalation: Transfer to human after 3 failed attempts
    â””â”€â”€ PII handling: Mask credit card numbers
```
