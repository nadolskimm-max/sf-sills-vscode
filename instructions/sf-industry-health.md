---
description: >-
  Builds Health Cloud features including FHIR integration, Care Plans, Patient/Member data models, and healthcare compliance patterns. Use when working with Health Cloud objects, implementing FHIR resources, building care coordination, or ensuring HIPAA compliance patterns. Do NOT use for general Salesforce objects (use sf-metadata) or standard integrations (use sf-integration).
---
