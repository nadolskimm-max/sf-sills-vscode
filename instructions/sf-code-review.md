---
description: >-
  Reviews Salesforce code (Apex, LWC, Flows) against best practices with a structured scoring rubric. Use when performing code reviews, generating review checklists, scoring code quality, or creating PR templates for Salesforce projects. Do NOT use for writing new code (use sf-apex, sf-lwc, sf-flow) or debugging (use sf-debug).
---
