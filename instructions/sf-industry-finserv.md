---
description: >-
  Builds Financial Services Cloud features including KYC, AML, wealth management, financial accounts, and compliance automation. Use when working with Financial Services Cloud objects, implementing KYC/AML workflows, building financial account hierarchies, or ensuring financial compliance patterns. Do NOT use for general Apex (use sf-apex) or standard integrations (use sf-integration).
---
...
```
1. Customer Identification â†’ Collect ID documents
2. Verification â†’ Validate against external databases
3. Risk Assessment â†’ Score based on risk indicators
4. Enhanced Due Diligence â†’ Additional checks for high-risk
5. Approval â†’ Compliance officer sign-off
6. Ongoing Monitoring â†’ Periodic review
```
...
â”śâ”€â”€ Entry: Account created with RecordType = 'Client'
â”śâ”€â”€ Create KYC_Review__c record (Status = 'Pending')
â”śâ”€â”€ Decision: Is high-risk country?
â”‚   â”śâ”€â”€ Yes â†’ Set Risk_Level__c = 'High', route to Compliance Queue
â”‚   â””â”€â”€ No â†’ Set Risk_Level__c = 'Standard'
â””â”€â”€ Email Alert: Notify assigned reviewer
```
