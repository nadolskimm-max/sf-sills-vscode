---
description: >-
  Manages Apex test execution, code coverage analysis, and test data generation. Use when running tests, checking coverage, generating test classes, creating bulk test data (200+ records), or debugging test failures. Do NOT use for non-test Apex (use sf-apex) or Jest/LWC tests (use sf-lwc).
applyWhen: "**/*Test.cls"
---
...
private class MyServiceTest {
    @TestSetup
    static void setup() {
        // Create shared test data â€” runs once, rolled back after class
...
| Anti-Pattern | Fix |
|---|---|
| `SeeAllData=true` | Remove â€” create test data in `@TestSetup` |
