---
description: >-
  Designs and implements custom REST and SOAP APIs exposed from Salesforce using @RestResource, @HttpGet, @WebService, and Composite API patterns. Use when building custom endpoints, designing API contracts, versioning APIs, or creating Composite/Batch request handlers. Do NOT use for outbound callouts (use sf-integration) or Connected App OAuth (use sf-connected-apps).
---
