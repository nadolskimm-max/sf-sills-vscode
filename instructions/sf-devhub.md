---
description: >-
  Manages Salesforce DevHub including scratch org pools, shape orgs, namespace management, and scratch org configuration. Use when setting up DevHub, managing scratch org definitions, creating org shapes, or troubleshooting scratch org limits. Do NOT use for regular deployment (use sf-deploy) or package versioning (use sf-package).
---
